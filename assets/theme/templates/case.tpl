                ...
                <div class="case__gradient {if $_modx->resource.first_section_gradient == 1}_gradient{/if}" {if $_modx->resource.first_section_gradient == 1}style="background: linear-gradient({$_modx->resource.first_section_gradient_direction}, {$_modx->resource.first_section_gradient1}, {$_modx->resource.first_section_gradient2 ? $_modx->resource.first_section_gradient2~', ' : ''}{$_modx->resource.first_section_gradient3});"{/if}>
                    {if $_modx->resource.first_section_image}
                        ...
                        <picture class="case__gradient-picture picture">
                            ...
                            <img src="{$first_section_image}" srcset="{$first_section_image_2x} 2x, {$first_section_image} 1x" alt="{$_modx->resource.pagetitle | escape}" width="1820" height="1000" data-aos="opacity">
                        </picture>
                    {else}
            ...
            <div class="case__pictures">
                {if $_modx->resource.second_section_image1}
                    ...
                    <picture class="case__pictures-picture picture">
                        ...
                        <img src="{$second_section_image1_webp}" srcset="{$second_section_image1_webp_2x} 2x, {$second_section_image1_webp} 1x" alt="{$_modx->resource.pagetitle | eccape}" width="664" height="756" data-aos="fade-right">
                    </picture>
                {else}
                ...
                {if $_modx->resource.second_section_image2}
                    ...
                    <picture class="case__pictures-picture picture">
                        ...
                        <img src="{$second_section_image2_webp}" srcset="{$second_section_image2_webp_2x} 2x, {$second_section_image2_webp} 1x" alt="{$_modx->resource.pagetitle | eccape}" width="1255" height="756" data-aos="fade-left">
                    </picture>
                {else}
        ...
        <div class="section">
            {if $_modx->resource.third_section_image}
                ...
                <picture class="case__picture picture">
                    ...
                    <img src="{$third_section_image}" srcset="{$third_section_image_2x} 2x, {$third_section_image} 1x" alt="{$_modx->resource.pagetitle | escape}" width="1920" height="2086" data-aos="opacity">
                </picture>
            {else}
        ...
        <div class="section">
            {if $_modx->resource.fourth_section_image}
                ...
                <picture class="case__picture picture">
                    ...
                    <img src="{$fourth_section_image}" srcset="{$fourth_section_image_2x} 2x, {$fourth_section_image} 1x" alt="{$_modx->resource.pagetitle | escape}" width="1920" height="2086" data-aos="opacity">
                </picture>
            {else}
